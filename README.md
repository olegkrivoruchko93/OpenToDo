...
OpenToDo — локальное веб-приложение для управления личными задачами. Проект написан на Flask, использует SQLite через Flask-SQLAlchemy и запускается одним Python-процессом.

## Возможности

- регистрация, вход и выход пользователей;
- личные задачи для каждого пользователя;
- создание, редактирование, выполнение и окончательное удаление задач;
- описание задачи, дата и время дедлайна;
...
- База данных хранится локально в SQLite-файле `todo.db`.
